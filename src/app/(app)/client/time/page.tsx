                  ...
                  return (
                    <tr key={e.id} className="border-b border-border last:border-0 hover:bg-muted/40">
                      ...
                      <td className="px-5 py-3 text-muted-foreground">
                        {p ? (
                          <div>
                            <Link href={`/client/projects/view?projectId=${p.id}`} className="hover:text-primary transition-colors font-medium">
                              {p.name}
                            </Link>
                            {t && (
                              <Link
                                href={`/client/projects/view?projectId=${p.id}&tab=tasks`}
