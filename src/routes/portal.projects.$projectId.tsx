...
export const Route = createFileRoute("/portal/projects/$projectId")({ component: PortalProjectDetail });
...
function PortalProjectDetail() {
  ...
  return (
    <PortalShell>
      <Link to="/portal/projects" className="mb-4 inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-foreground">
