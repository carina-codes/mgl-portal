...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Agency execution platform — projects, requests, deliverables, time and client collaboration in one place." },
      { property: "og:title", content: "MGL Client Platform" },
      { property: "og:description", content: "The operating system for a high-end digital agency." },
